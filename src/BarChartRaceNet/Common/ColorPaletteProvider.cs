namespace BarChartRaceNet.Common
{
    ...
    public static class ColorPaletteProvider
    {
        ...
        {
            var colors = new List<Color>(IndexColors.Length);
            ...
            foreach (var indexColor in IndexColors)
            {
                var color = (Color)ColorConverter.ConvertFromString(indexColor);
                colors.Add(color);
            }
        ...
        /// <summary>
        /// Gets the IndexColors.
        /// </summary>
        private static string[] IndexColors { get; } = new string[]
        {
